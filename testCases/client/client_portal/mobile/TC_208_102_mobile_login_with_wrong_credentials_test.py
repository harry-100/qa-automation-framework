...
class Test_TC208_102_MobileLoginWithWrongCredentials:

	@pytest.fixture(autouse=True)
	def class_setup(self, one_time_setup):
		self.driver.set_window_size(411, 823)

	def test_mobile_login_with_wrong_credentials(self):

		# get the required data
		client_portal_url = XLUtility.readData(self.path_1, 'client_portal_mobile_data', 4, 2)
		user_name = XLUtility.readData(self.path_1, 'client_portal_mobile_data', 4, 3)
		password = XLUtility.readData(self.path_1, 'client_portal_mobile_data', 4, 4)
