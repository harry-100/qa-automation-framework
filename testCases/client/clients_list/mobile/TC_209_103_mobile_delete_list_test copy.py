...
class Test_TC209_001_MobileCreatePrivateList:
	...
	def test_mobile_create_private_client_list(self):
		common = CommonMethods(self.driver)
		self.log.info("starting test {}...".format(__name__))
		client_name = []
		# get the required data
		list_name = XLUtility.readData(self.path_1, 'clients_list_mobile_data', 2, 2)
		tag_name = XLUtility.readData(self.path_1, 'clients_list_mobile_data', 2, 3)
		client_name.append(XLUtility.readData(self.path_1, 'clients_list_mobile_data', 2, 4))
		client_name.append(XLUtility.readData(self.path_1, 'clients_list_mobile_data', 2, 5))
		...
		no_of_lists = self.clients_list_page_obj.get_no_of_mobile_client_lists()
		for i in range(no_of_lists):
			self.clients_list_page_obj.clk_mobile_client_list()
			sleep(1)
		...
		if list_name not in clients_list:
