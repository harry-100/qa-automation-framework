...
class Test_TC209_002_CreatePublicClientList:
	...
	def test_create_public_client_list(self):
		common = CommonMethods(self.driver)
		self.log.info("starting test {}...".format(__name__))
		client_name = []
		# data required
		list_name = XLUtility.readData(self.path_1, 'clients_list_data', 4, 2)
		tag_name = XLUtility.readData(self.path_1, 'clients_list_data', 4, 3)
		client_name.append(XLUtility.readData(self.path_1, 'clients_list_data', 4, 4))
		client_name.append(XLUtility.readData(self.path_1, 'clients_list_data', 4, 5))
