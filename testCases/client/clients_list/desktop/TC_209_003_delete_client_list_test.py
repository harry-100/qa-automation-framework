...
class Test_TC209_001_CreatePrivateClientList:
	...
	def test_create_private_client_list(self):
		...
		client_name = []
		# data required
		list_name = XLUtility.readData(self.path_1, 'clients_list_data', 6, 2)
		tag_name = XLUtility.readData(self.path_1, 'clients_list_data', 6, 3)
		client_name.append(XLUtility.readData(self.path_1, 'clients_list_data', 6, 4))
		client_name.append(XLUtility.readData(self.path_1, 'clients_list_data', 6, 5))
