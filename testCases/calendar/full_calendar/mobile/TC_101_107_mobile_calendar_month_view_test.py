...
# this test checks monthly view of calendar
@pytest.mark.usefixtures("one_time_setup")
class Test_TC101_107_CalendarMonthlyView:
	...
	def test_calender_month_view(self):
		...
		sleep(1)
		self.calendar_page_obj.clk_mobile_calendar_month_view()
		sleep(0.5)
		...
		if exp_date_format in month_view_info:
			self.log.info("{} passed!".format(__name__))
			assert True
		else:
			self.driver.save_screenshot(
				self.pathScreenShot + "Test_TC101_107_CalendarMonthlyView" + self.dateFormat + ".png"
			)
